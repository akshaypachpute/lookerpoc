view: tbl_order {
  sql_table_name: `LOOKER.tblOrder`
    ;;

  parameter: monthStartDate {type:date}
  parameter: nextMonthStartDate {type:date}
  ...
  measure: customer_count {
   ...
   measure: revenue {
    type: sum
    sql:  case when ${TABLE}.RoundOfSign =  '+' THEN ${order_bill_amount} + ${round_of_val} else  ${order_bill_amount} - ${round_of_val} end;;
    drill_fields: []
  }
